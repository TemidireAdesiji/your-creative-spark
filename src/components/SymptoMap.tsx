...
const AddConditionModal=({onClose})=>{
  ...
  return(
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.55)",zIndex:1100,display:"flex",alignItems:"flex-end"}} onClick={onClose}>
      <div onClick={e=>e.stopPropagation()} style={{width:"100%",background:"#fff",borderRadius:"28px 28px 0 0",animation:"slide-up .35s ease",maxHeight:"85dvh",overflow:"hidden",display:"flex",flexDirection:"column",paddingBottom:"env(safe-area-inset-bottom,0px)"}}>
        ...
        <div style={{overflowY:"auto",WebkitOverflowScrolling:"touch",overscrollBehavior:"contain",padding:"8px 20px 20px",flex:"1 1 auto",minHeight:0,touchAction:"pan-y",msOverflowStyle:"auto"}}>
